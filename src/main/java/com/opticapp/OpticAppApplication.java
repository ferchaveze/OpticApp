package com.opticapp;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.opticapp.domain.Difficulty;
import com.opticapp.domain.Region;
import com.opticapp.service.TourPackageService;
import com.opticapp.service.TourService;
...
public class OpticAppApplication implements CommandLineRunner{
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(OpticAppApplication.class, args);
	}
